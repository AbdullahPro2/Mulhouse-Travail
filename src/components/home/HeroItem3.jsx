...
function HeroItem3() {
  return (
    <div className="flex h-[280px]  justify-between bg-[#45B1E8] sm:h-[370px]  md:h-[470px] ">
      <div className=" my-auto flex max-w-[50%] flex-col gap-2 pl-2 sm:gap-3 sm:px-3 md:gap-4 lg:px-5 xl:gap-6 xl:px-8">
        ...
        <NavLink to="/comment-rédiger-cv">
          <button className="mt-3  w-fit   bg-white  px-4 py-[5px]  text-sm font-semibold sm:text-lg  lg:py-3 lg:text-xl xl:px-8 xl:py-4  ">
            Savoir plus
          </button>
        </NavLink>
      </div>

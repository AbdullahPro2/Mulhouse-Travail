...
function HeroItem2() {
  return (
    <div className=" flex h-[280px]  justify-between bg-[#003C43] sm:h-[370px] md:h-[470px] ">
      <div className=" my-auto flex max-w-[50%] flex-col gap-2 pl-2 sm:gap-3 sm:px-3 md:gap-4 lg:px-5 xl:gap-6 xl:px-8">
        <h1 className=" text-base uppercase tracking-[9%] text-white xs:text-lg sm:text-xl lg:text-2xl xl:text-4xl">
          ...
          <br />
          <span className="font-black tracking-[9%] text-[#FF9C24]">
            EMPLOI IDÉAL <br />
          </span>
        </h1>
        ...
        <button className="mt-3 w-fit rounded-[100px] bg-[#FF9C24] px-4  py-[5px] text-[10px] font-semibold xs:text-sm  sm:text-lg  lg:px-6 lg:py-3 lg:text-xl xl:px-7  ">
          Trouve maintenant
        </button>
      </div>
      <div className="mx-auto mb-4 flex max-h-[70%] max-w-[50%] items-end justify-center overflow-hidden rounded-b-full bg-[#FF9C24] md:max-h-[90%]">
        <img
          src={heroItemImg}

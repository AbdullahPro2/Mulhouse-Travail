...
function Navbar({ isOpen, setIsOpen }) {
  return (
    ...
    >
      ...
      <div
        className={` absolute left-0 top-0 z-40 flex h-screen  -translate-x-full flex-col justify-between  overflow-auto !bg-[#004d40] !bg-opacity-100 pt-20 text-sm text-[white] transition-all duration-150 ease-in-out lg:fixed lg:w-[200px] lg:translate-x-0 xl:w-[15.8%] xl:text-base ${
